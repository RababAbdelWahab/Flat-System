...
@endif
    <h4>حذف مستحقات الشقق </h4> 
    
    <form method="POST" action="{{ route('flatsreceivables.destroy',1) }}" enctype="multipart/form-data"
                              class="col-md-offset-1 col-md-10 col-md-offset-1">
                              @csrf 
                              {{ method_field('PUT') }}
                              <div class="form-group">
                                <label class="labelFields" for="flatId"> رقم الشقة المراد حذف مستحق لها *</label>
